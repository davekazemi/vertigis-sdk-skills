...
2. **If Existing Project Found**: Ask whether the user wants to **[Review Code]** (categorized by Critical Errors, Architectural Warnings, and Cleanliness Recommendations), **[Add New Activity]**, **[Add New Form Element]**, or **[Generate Scripts]**.
